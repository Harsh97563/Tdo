...
import { addTodoAtom, allTodosAtom, editTodoAtom, editTodoIDAtom, jwtTokenAtom, rerenderAton, timeAtom } from '../State_Recoil/atom'
...
function AddTodo() {
  ...
  return (
    <div className={`fixed flex flex-col left-[-85vw] md:left-[-50vw] justify-between items-center duration-700 w-[80vw] md:w-[45vw] h-[50vh] md:h-[80vh] ${addTodo} bg-teal-900 rounded-3xl p-10`}>
