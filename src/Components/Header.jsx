...
import { addTodoAtom, writingtodoAtom } from '../State_Recoil/atom'
...
function Header() {
  ...
  return (
    <div className='flex fixed w-[100vw]'>
        ...
        <nav className='flex bg-gray-400 text-white rounded-xl p-4 items-center justify-between  m-4 w-[98vw]'>
          <div>
          ...
          <div className='flex items-center'>
            <input type="text" placeholder='Add Todos' className='w-[35vw]  rounded-xl text-gray-900 border-none p-2 '  onClick={
              ()=>{
                setAddTodo("translate-x-[90vw] md:translate-x-[70vw]")
                }} onChange={(e)=>{
                  setWritingtodo(e.target.value)
                }} />
          </div>
