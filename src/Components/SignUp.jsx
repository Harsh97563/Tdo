...
function SignUp() {
  ...
  return (
    <div className='w-[100vw] flex items-center justify-center  h-[100vh] bg-emerald-400 '>
        ...
        <div className=' flex flex-col items-center rounded-3xl justify-between p-4 w-[95vw] md:w-[30vw] h-[50vh] md:h-[65vh] bg-teal-900'>
            <div className='text-white text-5xl font-mono font-bold underline decoration-lime-400'>Sign Up</div>
            <div className='flex w-full flex-col'>
                ...
                <input className='p-2 rounded-lg m-2 focus:bg-green-300 focus: outline-none' placeholder='First Name' type="text" onChange={(e)=>{
                    setFirstName(e.target.value)
                }} />
                <input className='p-2 rounded-lg m-2 focus:bg-green-300 focus: outline-none' placeholder='Last Name' type="text" onChange={(e)=>{
                    setLastName(e.target.value)
                }}/>
                <input className='p-2 rounded-lg m-2 focus:bg-green-300 focus: outline-none' placeholder='Password' type="text" onChange={(e)=>{
                    setPassword(e.target.value)
                }} />
                
            </div>
            <button className='bg-teal-700 m-2 w-[70vw] md:w-[15vw] h-[6vh] flex rounded-lg justify-center items-center' onClick={async()=>{
                setLoading(true)
                const tempformdata= {
                    email: Email,
                    firstName: firstName,
       ...
       </div> : <div className='font-bold text-white font-mono text-xl'>Sign Up</div> }</button>
            <div className='text-white'>Already Signed Up? <span className='underline font-bold text-lime-500'><a href="/SignIn">Login</a></span></div>
        </div>
        <ToastContainer/>
    </div>
  )
